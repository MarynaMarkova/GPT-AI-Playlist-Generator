...
def main():
    parser = argparse.ArgumentParser(description="Simple command line song utiltiy")
    parser.add_argument(
        "-p", type=str, default="fun songs", help="The prompt to describe the playlist."
    )
    parser.add_argument(
        "-n", type=int, default=8, help="The number of songs to be added."
    )
    parser.add_argument(
        "-envfile",
        type=str,
    ...
    messages = [
        {
            ...
            You should generate a list of songs and their artists 
...
def add_songs_to_spotify(playlist_prompt, playlist):
    ...
    # Step 3. Click "Edit Settings" and "http://localhost:9999" as a "Redirect URI"
    spotipy_redirect_url = "http://localhost:9999"  # Your browser will return page not found at this step. We'll grab the URL and paste it to our console.
